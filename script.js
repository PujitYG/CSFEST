...
},
{
    ...
    "rounds": ["The participants will begiven a set of questions which should be answered in a time span of 20 minutes 5 Participants with most number of correct answers will be selected for second round.",
...
},
{
    ...
    "rules": "Counter Strike Source. It will be a 2v2 event Will be hosting it on lan in one of the labs.Till finals all the rounds are race to 9 and the finals will be a competitive match for 30 rounds (overtime included) Map pools are Dust 2, Dust, Inferno, and Nuke Knife round decides start side and game starts with pistol round",
    "rounds": [],
    "date": "9th",
    "time": "10AM",
    "venue": "Networking Lab",
...
},
{
    ...
    "rules": "1.There will be a total of 4 rounds. All the participants will be given a task to perform. The task has to be completed within 1 min (60 sec) in order to win that round and advance to the next round. Each round has a different challenge. ",
    "rounds": [
...
},
{
    ...
    "rules": "If caught cheating you will be disqualified. Organizers decision is final. Any such conflicts with the organisers will be disqualified.",
    "rounds": [
